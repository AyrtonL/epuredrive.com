const translations = {
  ...
  // Checkout page
  "Your Trip": "Tu Viaje",
  "Confirm your dates and pick-up location.": "Confirma tus fechas y lugar de recogida.",
  "Pick-up Date": "Fecha de Recogida",
  "Return Date": "Fecha de Devolución",
  "Pick-up Time": "Hora de Recogida",
  "Return Time": "Hora de Devolución",
  "Pick-up Location": "Lugar de Recogida",
  "Change dates": "Cambiar fechas",
  "Checking availability…": "Verificando disponibilidad…",
  "Continue →": "Continuar →",
  "Driver Details & Add-ons": "Datos del Conductor y Extras",
  "Fill in the primary driver's information and choose any extras.": "Ingresa los datos del conductor principal y elige tus extras.",
  "First Name": "Nombre",
  "Last Name": "Apellido",
  "Email Address": "Correo Electrónico",
  "Phone Number": "Teléfono",
  "Driver's License": "Licencia de Conducir",
  "🇺🇸 US License": "🇺🇸 Licencia EEUU",
  "🌍 International": "🌍 Internacional",
  "Issuing State": "Estado Emisor",
  "License Number": "Número de Licencia",
  "License Issuing Country": "País Emisor de Licencia",
  "Passport Number": "Número de Pasaporte",
  "Required at pick-up": "Requerido al recoger",
  "As shown on your license": "Como aparece en tu licencia",
  "International drivers must present their foreign license + passport at pick-up. An IDP (International Driving Permit) is recommended but not required.": "Los conductores internacionales deben presentar su licencia extranjera + pasaporte al recoger. Se recomienda un PIC (Permiso Internacional de Conducir), aunque no es obligatorio.",
  "⚠ International drivers: Premium Coverage is strongly recommended — your home country's policy may not cover US rentals.": "⚠ Conductores internacionales: se recomienda encarecidamente la Cobertura Premium — la póliza de tu país puede no cubrir alquileres en EE.UU.",
  "Basic Liability": "Responsabilidad Básica",
  "Florida state minimum. Requires valid US insurance or qualifying credit card. Higher security deposit at pick-up.": "Mínimo estatal de Florida. Requiere seguro estadounidense válido o tarjeta de crédito habilitada. Mayor depósito de seguridad al recoger.",
  "Physical damage waiver up to $100K. Recommended for international drivers. Lower security deposit.": "Exención de daños físicos hasta $100K. Recomendado para conductores internacionales. Menor depósito de seguridad.",
  "Date of Birth": "Fecha de Nacimiento",
  "⚠ Under-25 fee applies: +$25 / day added automatically.": "⚠ Aplica cargo por conductor menor de 25: +$25 / día agregado automáticamente.",
  "Protection & Coverage": "Protección y Cobertura",
  "Standard Protection": "Protección Estándar",
  "State minimum liability. Security deposit required at pick-up.": "Responsabilidad civil mínima. Se requiere depósito de seguridad al recoger.",
  "Included": "Incluido",
  "Premium Coverage": "Cobertura Premium",
  "Physical damage waiver up to $100K. Lower security deposit.": "Exención de daños físicos hasta $100K. Menor depósito de seguridad.",
  "Equipment & Services": "Equipamiento y Servicios",
  "Prepaid Fuel": "Combustible Prepagado",
  "Return the car at any fuel level — no refueling needed.": "Devuelve el auto con cualquier nivel de combustible, sin necesidad de repostar.",
  "Additional Driver": "Conductor Adicional",
  "Allow a second verified driver to operate the vehicle.": "Permite que un segundo conductor verificado opere el vehículo.",
  "← Back": "← Atrás",
  ...
  "Taxes & Fees (9.5%)": "Impuestos y Cargos (9,5%)",
  "Total": "Total",
  "WhatsApp": "WhatsApp",
  "Book Now": "Reservar Ahora"
};
