    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 text-center pt-16 pb-24">
        <div className="inline-flex items-center gap-2.5 bg-white/[0.07] border border-white/[0.12] rounded-full px-4 py-2 mb-8 animate-fade-in">
          ...
          <span className="text-[10px] font-black uppercase tracking-[.3em] text-silver">{displayName}</span>
        </div>
        ...
        <p className="text-grey text-base sm:text-lg max-w-2xl mx-auto leading-relaxed mb-10 animate-fade-in animation-delay-200">
          {description}
        </p>
