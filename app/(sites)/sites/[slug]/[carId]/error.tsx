...
export default function CarDetailError({ error: _error, reset }: Props) {
        ...
        <div className="glass rounded-[2rem] border border-white/10 p-10 max-w-md w-full text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-white/40 text-sm leading-relaxed">
              We couldn&apos;t load this vehicle&apos;s details. Please try again or go back to browse other cars.
            </p>
          </div>
