      ...
      <div className="p-8 space-y-6 text-sm text-gray-800">
        ...
        <section>
          ...
          <div className="text-[11px] text-gray-600 leading-relaxed space-y-2 border border-gray-200 rounded-lg p-4 bg-gray-50">
            ...
            <p><strong>20. GOVERNING LAW; MISCELLANEOUS.</strong> This Agreement is governed by the laws of the State of Florida, and the parties consent to the jurisdiction of the courts located there. No term may be waived or modified except in a writing signed by us. This Agreement is the entire agreement between the parties; all prior representations are void. If any provision is held void or unenforceable, the remaining provisions remain valid. To the extent permitted by law, you and we each waive the right to a trial by jury in any proceeding arising out of this Agreement.</p>
